...
ActiveRecord::Schema.define(version: 2018_12_19_103803) do
  ...
  create_table "activities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id", "action_id", "action_type"], name: "index_activities_on_user_id_and_action_id_and_action_type"
